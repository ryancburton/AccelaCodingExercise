...
namespace ContactDetails
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddDbContext<ContactDetailsContext>(options =>options.UseSqlServer(Configuration.GetConnectionString("ContactDetailsContext")));
        ...
        public void Configure(IApplicationBuilder app, IWebHostEnvironment env)
        {
           ...
           // {
           //     DefaultFileNames = new List<string> { "ContactDetailsView.cshtml" }
           // });
            ...
            app.UseEndpoints(endpoints =>
            {
                endpoints.MapControllerRoute(
                    ...
                    pattern: "{controller=ContactDetails}/{action=Index}/{id?}");
            });
        }
    }
}
